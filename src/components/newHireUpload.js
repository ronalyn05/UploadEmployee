...
const NewHireUpload = () => {
  ...
  const handleSaveData = async () => {
    try {
      ...
      alert(
        'Error occurred while saving data. Please try again later.Please check your uploaded data. Make sure all fields have values or replace empty fields with "N/A".'
      );
    }
  };
