...
function Dashboard() {
  ...
  useEffect(() => {
    const fetchNumberOfUsers = async () => {
      try {
        const response = await axios.get(variables.API_URL + "UserAccount"); // API endpoint to fetch employees count is '/UserAccount'
  ...
  useEffect(() => {
    const fetchNumberOfEmployees = async () => {
      try {
        const response = await axios.get(variables.API_URL + "Employee"); // API endpoint to fetch employees count is '/Employee'
